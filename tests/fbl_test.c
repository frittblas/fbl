...
void fbl_start()
{
	...
	fbl_load_ui_texture("assets/ui.png");
...
void setup_demo_1()
{
	...
	fbl_load_ttf_font("assets/edosz.ttf", 30);
...
void run_demo_1()
{
	...
	if (fbl_get_key_down(FBLK_SPACE) && loly == 0)
	{
		...
		loly = 1;
		fbl_submit_task_tp(create_1000_sprites);
	...
	if (fbl_get_key_down(FBLK_RETURN) && fbl_get_fps_locked())
	{
		...
		//fbl_lua_do_file("assets/main_.lua");
...
void setup_demo_2(void)
{
	...
	fbl_load_texture("assets/ui.png");
	...
	ping_sound = fbl_load_sound("assets/door.ogg"); 

	fbl_load_music("assets/song_99.ogg");	// only one piece of music is loaded at a time
...
void setup_demo_4()
{
	...
	*/
	...
	fbl_load_texture("assets/spritesheet_.png");
